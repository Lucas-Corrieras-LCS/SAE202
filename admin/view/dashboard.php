...
<body>
    ...
    <div class="container">
        ...
        <ul>
            <li><a href="/sae202/admin/routeur.php?page=utilisateurs">Gérer les utilisateurs</a></li>
            <li><a href="/sae202/admin/routeur.php?page=commentaires">Gérer les commentaires</a></li>
        </ul>
    </div>
</body>
