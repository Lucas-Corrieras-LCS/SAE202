        ...
        <tbody>
            <?php foreach ($utilisateurs as $utilisateur): ?>
                <tr>
                    ...
                    <td>
                        <a
                            href="/sae202/admin/routeur.php?page=modifier_utilisateur&id=<?= $utilisateur['id'] ?>">Modifier</a>
                        <a href="/sae202/admin/routeur.php?page=supprimer_utilisateur&id=<?= $utilisateur['id'] ?>"
